...
gen "card-weddings.png"     "/generate 'a delicate garden wedding arch woven with white roses and trailing greenery, ${STYLE}, warm cream background' --aspect=1:1"
gen "card-photoshoots.png"  "/generate 'a vintage film camera framed by ferns, blossoms and trailing vines, ${STYLE}, warm cream background' --aspect=1:1"
gen "card-celebrations.png" "/generate 'a timber garden pavilion draped with warm string lights and floral garlands, ${STYLE}, warm cream background' --aspect=1:1"
